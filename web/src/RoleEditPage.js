  ...
  renderRole() {
    return (
      <Card size="small" title={
        ...
        <Row style={{marginTop: "20px"}} >
          <Col style={{marginTop: "5px"}} span={(Setting.isMobile()) ? 19 : 2}>
            {Setting.getLabel(i18next.t("general:Manual Override"), i18next.t("general:Manual Override - Tooltip"))} :
          </Col>
          <Col span={1} >
            <Switch checked={this.state.role.manualOverride} onChange={checked => {
              this.updateRoleField("manualOverride", checked);
            }} />
          </Col>
        </Row>
      </Card>
