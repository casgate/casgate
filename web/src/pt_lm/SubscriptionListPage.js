...
class SubscriptionListPage extends BaseListPage {
  ...
  fetch = (params = {}) => {
    ...
    SubscriptionBackend.getSubscriptions(Setting.isAdminUser(this.props.account) || Setting.isDistributor(this.props.account) ? "" : this.props.account.owner, params.pagination.current, params.pagination.pageSize, field, value, sortField, sortOrder)
      .then((res) => {
        this.setState({
          loading: false,
        });
