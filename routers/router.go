...
func initAPI() {
	...
	beego.Router("/api/get-auth-url", &controllers.ApiController{}, "GET:GetAuthURL")
	...
	beego.Router("/api/add-user-id-provider", &controllers.ApiController{}, "POST:AddUserIdProvider")
	...
	beego.Router("/api/ready", &controllers.ApiController{}, "GET:Ready")
